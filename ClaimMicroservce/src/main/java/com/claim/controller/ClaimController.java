...
public class ClaimController {
	...
	@GetMapping("claim/getClaimByPlanId/{planId}")
	public Claim getClaimByEmail(@PathVariable Long planId) {
		return claimService.getClaimByPlanId(planId);
		
	}
	
	@PostMapping("claim/updateClaimStatus/{claimId}")
	public String updateClaimStatus(@PathVariable Long claimId, @RequestBody String status) {
